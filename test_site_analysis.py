...
class TestVBulletinTopic(unittest.TestCase):
   ...
   def test_VBulletin_Topic_match(self):
       self.assertTrue(self.vbt.match('http://www.ilgiramondo.net/forum/trentino-alto-adige/15753-trentino-alto-adige.html'))
   ...
   def test_VBulletin_Topic_run_on_page(self):
       ...
       self.assertEqual(len(list(self.vbt.run('http://www.ilgiramondo.net/forum/trentino-alto-adige/15753-trentino-alto-adige.html'))),18)
...
class TestVBulletinSection(unittest.TestCase):
   ...
   def test_VBulletin_Section_match(self):
       self.assertTrue(self.vbt.match('http://www.ilgiramondo.net/forum/trentino-alto-adige/'))
...
class TestTuristiPerCaso(unittest.TestCase):
   ...
   def test_TuristiPerCaso_match(self):
       self.assertTrue(self.tpc.match('http://turistipercaso.it/forum/t/71583/isole-della-grecia.html'))
       self.assertTrue(self.tpc.match('https://turistipercaso.it/forum/t/71583/isole-della-grecia.html'))
       self.assertTrue(self.tpc.match('http://www.turistipercaso.it/forum/t/71583/isole-della-grecia.html'))
       self.assertTrue(self.tpc.match('https://www.turistipercaso.it/forum/t/71583/isole-della-grecia.html'))
   ...
   def test_TuristiPerCaso_run_on_page(self):
       ...
       self.assertEqual(len(list(self.tpc.run('http://turistipercaso.it/forum/t/71583/isole-della-grecia.html'))),len(list(self.tpc.run('http://turistipercaso.it/forum/t/71583/isole-della-grecia.html'))))

class TestYahooAnswer(unittest.TestCase):
   ya = YahooAnswer()

   def test_Yahoo_Answer_match(self):
       self.assertTrue(self.ya.match('http://it.answers.yahoo.com/question/index?qid=20120617101809AAaPAeO')) #Topic
       self.assertTrue(self.ya.match('http://it.answers.yahoo.com/dir/index;_ylt=AlfwvVcRJfbSNGQd1gwtODlGWH1G;_ylv=3?sid=396546975&link=resolved#yan-questions')) #Section
       self.assertFalse(self.ya.match('https://login.yahoo.com/'))

   def test_Yahoo_Answer_run_on_page(self):
       self.assertEqual(len(list(self.ya.run('http://it.answers.yahoo.com/question/index?qid=20120617101809AAaPAeO'))),1)
       self.assertEqual(len(list(self.ya.run('http://it.answers.yahoo.com/dir/index;_ylt=AlfwvVcRJfbSNGQd1gwtODlGWH1G;_ylv=3?sid=396546975&link=resolved#yan-questions'))),20)

   def test_Yahoo_Answer_parser_threads(self):
       self.assertIsNone(self.ya.yahoo_page_parser('http://it.answers.yahoo.com/question/index?qid=20120617101809AAaPAeO')[0])
       thread_topics, messages_topic = self.ya.yahoo_page_parser('http://it.answers.yahoo.com/dir/index;_ylt=AlfwvVcRJfbSNGQd1gwtODlGWH1G;_ylv=3?sid=396546975&link=resolved#yan-questions')
       self.assertEqual(len(list(self.ya.found_thread_topics(thread_topics))),20)

   def test_Yahoo_Answer_parser_topic_messages(self):
       thread_topics, messages_topic = self.ya.yahoo_page_parser('http://it.answers.yahoo.com/question/index?qid=20120617101809AAaPAeO')
       self.assertEqual(len(list(self.ya.found_messages_topic(messages_topic))),1)
